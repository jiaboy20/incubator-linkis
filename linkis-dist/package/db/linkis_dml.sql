...
(1,'Yarn','default',NULL,'{\r\n\"rmWebAddress\": \"http://dev-fdh-node24:8088;http://dev-fdh-node23:8088\",\r\n\"hadoopVersion\": \"3.3.3\",\r\n\"authorEnable\":false,\r\n\"user\":\"\",\r\n\"pwd\":\"\",\r\n\"kerberosEnable\":false,\r\n\"principalName\":\"\",\r\n\"keytabPath\":\"\",\r\n\"krb5Path\":\"\"\r\n}');
...
# INSERT INTO `linkis_ps_dm_datasource_type_key` (`data_source_type_id`, `key`, `name`, `name_en`, `default_value`, `value_type`, `scope`, `require`, `description`, `description_en`, `value_regex`, `ref_id`, `ref_value`, `data_source`, `update_time`, `create_time`) VALUES (@data_source_type_id, 'brokers', 'Kafka集群(Broker List)', 'Broker List', NULL, 'TEXT', NULL, 1, 'Kafka集群(Broker List)', 'Broker List', NULL, NULL, NULL, NULL,  now(), now());
...
select @data_source_type_id := id from `linkis_ps_dm_datasource_type` where `name` = 'hive';
INSERT INTO `linkis_ps_dm_datasource_env` (`env_name`, `env_desc`, `datasource_type_id`, `parameter`, `create_time`, `create_user`, `modify_time`, `modify_user`) VALUES ('DEV环境', 'cdh-a-dev', @data_source_type_id, '{"uris":"thrift://bigd-cdh-a-dev-01:9083", "hadoopConf":{"hive.metastore.execute.setugi":"true"}}',  now(), NULL,  now(), NULL);
...
INSERT INTO `linkis_ps_dm_datasource_type_key`
    (`data_source_type_id`, `key`, `name`, `name_en`, `default_value`, `value_type`, `scope`, `require`, `description`, `description_en`, `value_regex`, `ref_id`, `ref_value`, `data_source`, `update_time`, `create_time`)
VALUES (@data_source_type_id, 'brokers', 'Kafka集群(Broker List)', 'Broker List', NULL, 'TEXT', NULL, 1, '地址(host1:port1,host2:port2...)', 'Address(host1:port1,host2:port2...)', NULL, NULL, NULL, NULL,  now(), now());
#
